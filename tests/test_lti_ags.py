...
class TestPassbackJobGrades:
    ...
    def test_passback_ags_includes_ai_notice_without_override(
        ...
        assert (
            comment
            == "<em>(This question's grade and feedback were generated by AI)<em>\n\nGood"
        )
    ...
    def test_passback_ags_includes_instructor_notice_with_override(
        ...
        assert (
            payload["comment"]
            == "<em>(This question's grade and feedback were modified by the instructor. "
            "AI assistance may have been used to write the provided feedback.)<em>"
    ...
    def test_passback_ags_includes_notice_for_feedback_only_override(
        ...
        assert (
            payload["comment"]
            == "<em>(This question's grade was generated by AI. The feedback was "
            "modified by the instructor. AI assistance may have been used to "
            "write the provided feedback.)<em>"
...
class TestPassbackQuizGradesViaRest:
    ...
    def test_passback_rest_uses_effective_grade_with_override(self, monkeypatch):
        ...
        assert (
            ...
            == "<em>(This question's grade and feedback were modified by the instructor. AI assistance may have been used to write the provided feedback.)<em>\n\nInstructor feedback"
        )
