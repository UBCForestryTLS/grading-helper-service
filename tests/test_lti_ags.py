...
class TestPassbackJobGrades:
    ...
    def test_passback_ags_includes_instructor_notice_with_override(
        ...
        assert (
            payload["comment"]
            == "<i>(This question's grade and feedback were modified by the instructor. "
            "AI assistance may have been used to write the provided feedback.)<i>"
    ...
    def test_passback_ags_includes_notice_for_feedback_only_override(
        ...
        assert (
            payload["comment"]
            == "<i>(This question's grade was generated by AI. The feedback was "
            "modified by the instructor. AI assistance may have been used to "
            "write the provided feedback.)<i>"
...
class TestPassbackQuizGradesViaRest:
    ...
    def test_passback_rest_uses_effective_grade_with_override(self, monkeypatch):
        ...
        assert (
            ...
            == "<i>(This question's grade and feedback were modified by the instructor. AI assistance may have been used to write the provided feedback.)<i>\n\nInstructor feedback"
        )
