...
class TestPassbackJobGrades:
    ...
    def test_passback_uses_lineitems_url_when_no_lineitem(
        ...
        def test_passback_skips_failed_submission_without_override(
            ...
            with patch(
                "src.lti.ags.httpx.post", return_value=mock_token_resp
            ) as mock_post:
                result = passback_job_grades(
    ...
    def test_passback_ags_includes_notice_for_feedback_only_override(
        ...
        assert (
            payload["comment"]
            == "(This question's grade was generated by AI. The feedback was "
            "modified by the instructor. AI assistance may have been used to "
            "write the provided feedback.)"
            "\n\nAlso cite your sources next time."
        )

    def test_passback_ags_includes_notice_for_grade_only_override(
        self, dynamodb_table, lti_env_vars
    ):
        """Only grade was overridden, feedback still comes from AI."""
        from uuid import uuid4
        from src.lti.ags import passback_job_grades
        from src.lti.launch_store import LaunchStore
        from src.models.grading_job import GradingJob
        ...
        assert (
            payload["comment"]
            == "(This question was manually graded by an instructor. The provided feedback was generated by AI)"
            "\n\nGood"
        )
